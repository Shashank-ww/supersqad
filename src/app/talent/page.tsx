  ...
  <MaxWidthWrapper>
    ...
    <div className="py-12 sm:py-16">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 className="px-4 mt-4 font-bold text-blue-500 md:mb-0 md:max-w-screen-md text-center mx-auto">
          FIND FAST, ASSIGN FASTER</h2>
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">Strategic Consultants</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              ...
              <div className="relative min-h-[30rem] w-full grow">
                <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
                  ...
                  <pre className="p-4 rounded-md text-wrap">
...
<MaxWidthWrapper>
      <div className="max-w-400 text-center items-center justify-center sm:pt-16 lg:flex flex-row">
        <div className="my-6 p-4 sm:text-center sm:justify-center">
          ...
          <p className="lg:text-right font-bold">FTE Allocation</p>
          <hr className="my-6"></hr>
          </div>
          <div>
          <h3 className="font-thin lg:text-7xl md:text-6xl text-5xl lg:text-right my-4">+8H</h3>
        ...
        <div className="my-6 p-4">
          <div>
          <h3 className="font-thin lg:text-7xl text-5xl lg:text-left my-4">6</h3>
          <p className="font-bold lg:text-left">Specialized Services</p>
          <hr className="my-6"></hr>
          </div>
          <div>

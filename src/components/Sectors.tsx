...
const Sectors = () => {
    return (
        ...
        <MaxWidthWrapper>
      <div className="max-w-screen-lg py-24 sm:py-16 mx-auto">
        ...
        <div className="max-w-screen-lg mx-auto py-24 sm:py-16 px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-4 sm:grid-cols-2 lg:grid-cols-3 gap-x-4">
            {sectorData.map((service, index) => (
              <div
                key={index}
                className="gap-4 p-6 rounded-md flex flex-col items-center justify-center shadow-lg hover:bg-blue-600 hover:text-white transition-colors duration-300">
                {service.icon}
